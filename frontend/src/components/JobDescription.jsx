...
const JobDescription = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto my-10">
      ...
      <div className="my-6 overflow-x-auto rounded-xl shadow-lg">
        <table className="min-w-full w-full bg-white">
          <tbody>
            {[
              ...
              >
                <td className="font-semibold text-indigo-700 px-6 py-4 whitespace-nowrap w-1/3 border-r border-gray-100">
                  {label}
                </td>
                <td className="text-gray-800 px-6 py-4 font-medium">{value}</td>
              </tr>
            ))}
          </tbody>
        </table>
